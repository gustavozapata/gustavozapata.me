...
//WORKING ON LOAD EVENT ON THE REPORT - ALSO ON LINE 144 onload="mamen()"
window.addEventListener("load", function() {
  console.log("loading 01");
});

// var elrepo = document.getElementById("reportTitle");
// elrepo.addEventListener("load", function() {
...
//ONLOAD EVENT ON THE REPORT FINISH
...
function generateReport(totalAmount, totalUnpaid) {
  var report_start =
    '<h1 id="reportTitle" onload="mamen()">Report</h1><div class="report-header">' +
    "<h2>Total Amount</h2>" +
    "<p>£ " +
